...
#define SYMBOL_TABLEPROP_TITLE _("Route Properties")
#define SYMBOL_TABLEPROP_IDNAME ID_ROUTEPROP
#define SYMBOL_TABLEPROP_SIZE wxSize(450, 300)
#define SYMBOL_TABLEPROP_POSITION wxDefaultPosition

#ifdef __WXOSX__
#define SYMBOL_TABLEPROP_STYLE \
...
public:
  /// Constructors
  static TableRoutes *getInstance(
      wxWindow *parent, wxWindowID id = SYMBOL_TABLEPROP_IDNAME,
      const wxString &caption = SYMBOL_TABLEPROP_TITLE,
      const wxPoint &pos = SYMBOL_TABLEPROP_POSITION,
      const wxSize &size = SYMBOL_TABLEPROP_SIZE,
      long style = SYMBOL_TABLEPROP_STYLE);
  ~TableRoutes();
  ...
  // private:
  TableRoutes();
  TableRoutes(wxWindow *parent, wxWindowID id = SYMBOL_TABLEPROP_IDNAME,
              const wxString &caption = SYMBOL_TABLEPROP_TITLE,
              const wxPoint &pos = SYMBOL_TABLEPROP_POSITION,
              const wxSize &size = SYMBOL_TABLEPROP_SIZE,
              long style = SYMBOL_TABLEPROP_STYLE);
